  ...
  return (
    <header className="mb-10 flex items-center justify-between max-md:flex-col max-md:items-start">
      ...
      <div className="flex items-center gap-6 max-md:mt-6 max-md:w-full max-md:justify-between max-sm:flex-wrap max-sm:gap-4">
        <button className="relative flex h-[45px] w-[45px] items-center justify-center rounded-full bg-white text-[#6c7380] shadow-[0_3px_10px_rgba(0,0,0,0.05)] transition duration-200 hover:-translate-y-1 hover:text-[#4270f4] hover:shadow-[0_5px_15px_rgba(0,0,0,0.1)]">
          <FaBell />
        ...
        <label className="flex w-[300px] items-center rounded-full bg-white px-6 py-3 shadow-[0_5px_15px_rgba(0,0,0,0.05)] transition duration-300 focus-within:-translate-y-0.5 focus-within:shadow-[0_5px_15px_rgba(66,112,244,0.15)] max-md:w-1/2 max-sm:mt-4 max-sm:w-full">
