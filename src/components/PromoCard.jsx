  ...
  return (
    <section className="relative mb-8 flex justify-between overflow-hidden rounded-[18px] bg-gradient-to-br from-[#edf0fb] to-[#dbe4ff] p-9 shadow-card max-xl:flex-col max-xl:gap-8">
      ...
      <div className="relative z-10 max-w-[50%] max-xl:max-w-full">
        <h2 className="mb-5 bg-gradient-to-r from-[#262a39] to-[#4270f4] bg-clip-text text-[28px] font-bold text-transparent max-sm:text-[22px]">
        ...
        <button className="rounded-full bg-[#4270f4] px-8 py-3.5 text-[15px] font-semibold text-white shadow-[0_8px_15px_rgba(66,112,244,0.3)] transition duration-300 hover:-translate-y-1 hover:bg-[#3265e6] hover:shadow-[0_10px_20px_rgba(66,112,244,0.4)] max-sm:px-5 max-sm:py-3">
          Explore Features
        </button>
      </div>

      <div className="relative flex h-[200px] w-[320px] rotate-[5deg] flex-col justify-between overflow-hidden rounded-[20px] bg-gradient-to-br from-[#6889ff] to-[#4270f4] p-6 text-white shadow-[0_15px_30px_rgba(66,112,244,0.3)] transition duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(66,112,244,0.4)] max-xl:h-[170px] max-xl:w-full max-xl:rotate-0">
