export default function TransferCard({ title, amount, Icon, onClick }) {
  return (
    <article onClick={onClick} className="group relative cursor-pointer overflow-hidden rounded-[18px] bg-white p-6 shadow-card transition duration-300 hover:-translate-y-2 hover:shadow-[0_15px_30px_rgba(0,0,0,0.1)]">
